...
import uz.fozilbekimomov.nfcreader.model.TLV
import uz.fozilbekimomov.nfcreader.model.TagAndLength
import uz.fozilbekimomov.nfcreader.model.commandhelpers.EmvTags
import uz.fozilbekimomov.nfcreader.utils.BytesUtils.byteArrayToInt
import uz.fozilbekimomov.nfcreader.utils.BytesUtils.matchBitByBitIndex
            ...
            while (nextOctet >= 0) {
                ...
                if (!matchBitByBitIndex(tlvIdNextOctet.toInt(), 7) ||
                    (matchBitByBitIndex(
                        ...
                        7
                    ) && tlvIdNextOctet.toInt() and 0x7f == 0)
                ) {
                    break
                }
            }
