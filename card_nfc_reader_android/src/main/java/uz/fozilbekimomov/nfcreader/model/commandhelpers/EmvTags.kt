...
import uz.fozilbekimomov.nfcreader.model.EvmTag
import uz.fozilbekimomov.nfcreader.model.EvmTag.TagValueTypeEnum
import uz.fozilbekimomov.nfcreader.utils.BytesUtils.bytesToStringNoSpace
...
object EmvTags {
    ...
    val RESPONSE_MESSAGE_TEMPLATE_1 = EvmTag(
        "80",
        TagValueTypeEnum.BINARY,
    ...
    val COMMAND_TEMPLATE = EvmTag(
        "83",
        TagValueTypeEnum.BINARY,
        "Command Template",
        "Identifies the data field of a command message"
    )
    val APPLICATION_FILE_LOCATOR = EvmTag(
        "94",
        TagValueTypeEnum.BINARY,
    ...
    val CARDHOLDER_NAME = EvmTag(
        "5f20",
        TagValueTypeEnum.TEXT,
        "Cardholder Name",
        "Indicates cardholder name according to ISO 7813"
    )
    val TERMINAL_TRANSACTION_QUALIFIERS = EvmTag(
        "9f66",
        TagValueTypeEnum.BINARY,
